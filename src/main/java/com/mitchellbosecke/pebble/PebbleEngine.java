...
public class PebbleEngine {
    ...
    public PebbleTemplate getTemplate(String templateName, String cacheKeyName){
        return this.getTemplate(templateName,  cacheKeyName, false);
    }

    public PebbleTemplate getTemplate(String templateName, String cacheKeyName, boolean skipCache){
        return this.getTemplate(templateName, this.loader, cacheKeyName, skipCache);
    }
    ...
    private PebbleTemplate getTemplate(String templateName, Loader loader) {
        return getTemplate(templateName, loader, null, false);
    }

    private PebbleTemplate getTemplate(String templateName, Loader loader, String cacheKeyName, boolean skipCache) {
        /*
        ...
        if(cacheKeyName == null) {
            cacheKeyName = templateName;
        }

        Object cacheKey = loader.createCacheKey(cacheKeyName);
        if(skipCache){
    ...
    private PebbleTemplate getPebbleTemplate(String templateName, Loader loader, Object cacheKey) {
        ...
        try {
            this.logger.trace("Tokenizing template named {}", cacheKey);
            ...
            TokenStream tokenStream = lexer.tokenize(templateReader, (String)cacheKey);
            ...
            PebbleTemplateImpl instance = new PebbleTemplateImpl(this, root, (String)cacheKey);
    ...
    public static class Builder {
        ...
        private boolean cacheTagActive = false;
        ...
        /**
         * Enable/disable Tag caches
         *
         * @param cacheTagActive toggle to enable/disable tag cache
         * @return This builder object
         */
        public Builder cacheTagActive(boolean cacheTagActive) {
            this.cacheTagActive = cacheTagActive;
            return this;
        }
